    ...
    return (
        ...
        >
            ...
            <div className={cls.ContainerCheckBox}>
                ...
                <div className={cls.UnitCheckbox}>
                    <Input className={cls.InputCheckbox} onChange={(event)=>setExcludeTechNews(event.target.checked)} type={"checkbox"}/>
                    Включать технические новости рынков
                </div>
                <div className={cls.UnitCheckbox}>
                    <Input className={cls.InputCheckbox} onChange={(event)=> setExcludeAnnouncements(event.target.checked)} type={"checkbox"}/>
